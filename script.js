...
class Pay extends HTMLElement {
  connectedCallback() {
    const siblings = Array.from(
      this.parentElement?.querySelectorAll("pay-option") || [],
    );
...
class Branch extends HTMLElement {
  connectedCallback() {
    ...
    this.innerHTML = `<article class="branch-card glass-card-light" data-aos="fade-up">
          <div class="branch-card__copy">
            <span class="branch-card__icon"><i data-lucide="map-pin" class="h-6 w-6"></i></span>
            <p class="branch-card__eyebrow">Branch location</p>
            <h3 class="branch-card__title">${city}</h3>
            <p class="branch-card__address">${address}</p>
            <div class="branch-card__actions">
              <a href="${directionsUrl}" target="_blank" rel="noopener" class="cta-button inline-flex items-center gap-2 rounded-xl bg-master-yellow px-5 py-3 text-sm font-black text-master-ink">
                Get Directions <i data-lucide="navigation" class="h-4 w-4"></i>
              </a>
              <span class="branch-card__tag">Open daily 9AM - 7PM</span>
            </div>
          </div>
...
function updateSlider(name) {
  ...
  const totalPages = Math.max(1, Math.ceil(visibleItems.length / perView));
  ...
  document.querySelectorAll("[data-slider-filter]").forEach((button) => {
    button.addEventListener("click", () => {
      ...
      document
        ...
        .forEach((filterButton) => filterButton.classList.remove("is-active"));
...
const productCatalog = [
  {
    title: "Desktop Package Promo 1",
    category: "pc",
    tag: "PC Deal",
    image: "assets/package1.jpg",
  },
  {
    title: "Desktop Package Promo 2",
    category: "pc",
    tag: "PC Deal",
    image: "assets/package2.jpg",
  },
  {
    title: "Desktop Package Promo 3",
    category: "pc",
    tag: "PC Deal",
    image: "assets/package3.jpg",
  },
  {
    title: "Desktop Package Promo 4",
    category: "pc",
    tag: "PC Deal",
    image: "assets/package4.jpg",
  },
  {
    title: "Desktop Package Promo 5",
    category: "pc",
    tag: "PC Deal",
    image: "assets/package5.jpg",
  },
  {
    title: "Ningmei NL150 Laptop",
    category: "laptop",
    tag: "Laptop Deal",
    image: "assets/laptop1.jpg",
  },
  {
    title: "Ningmei Laptop Promo 2",
    category: "laptop",
    tag: "Laptop Deal",
    image: "assets/laptop2.jpg",
  },
  {
    title: "Chuwi Laptop Promo",
    category: "laptop",
    tag: "Laptop Deal",
    image: "assets/laptop3.jpg",
  },
  {
    title: "Ningmei Laptop Promo 4",
    category: "laptop",
    tag: "Laptop Deal",
    image: "assets/laptop4.jpg",
  },
  {
    title: "Ningmei Laptop Promo 5",
    category: "laptop",
    tag: "Laptop Deal",
    image: "assets/laptop5.jpg",
  },
  {
    title: "Gaming Chair Promo 1",
    category: "gaming-chair",
    tag: "Gaming Chair",
    image: "assets/gamingchair1.jpg",
  },
  {
    title: "Gaming Chair Promo 2",
    category: "gaming-chair",
    tag: "Gaming Chair",
    image: "assets/gamingchair2.jpg",
  },
  {
    title: "Gaming Chair Promo 3",
    category: "gaming-chair",
    tag: "Gaming Chair",
    image: "assets/gamingchair3.jpg",
  },
  {
    title: "Gaming Chair Promo 4",
    category: "gaming-chair",
    tag: "Gaming Chair",
    image: "assets/gamingchair4.jpg",
  },
  {
    title: "Gaming Chair Promo 5",
    category: "gaming-chair",
    tag: "Gaming Chair",
    image: "assets/gamingchair5.jpg",
  },
  {
    title: "Gaming Chair Promo 6",
    category: "gaming-chair",
    tag: "Gaming Chair",
    image: "assets/gamingchair6.jpg",
  },
];
...
function initProductsPage() {
  ...
  let activeCategory = productCatalog.some(
    ...
    return productCatalog.filter((product) => {
      const matchesCategory =
        ...
        (activeCategory === "deals" &&
          product.tag.toLowerCase().includes("deal"));
      const matchesSearch =
        !query ||
  ...
  function scrollProductsToTop() {
    ...
    const getTop = () =>
      Math.max(0, target.getBoundingClientRect().top + window.scrollY - 104);
